...
symbols = {"A", "T", "U", "C", "G", "R", "Y", "S", "W", "K", "M", "B", "D", "H", "V", "N", "5", "3"}
...
def check_dimer(seq1, seq2, dict_format = False, basepair = {'A': 'U', 'U': 'A', 'C': 'G', 'G': 'C'}):
    ...
    for start_ind in range(len(seq1)+len(seq2)-2):
        ...
        num_bp = bp.count('┊')
        # create a index_num variable, which is the minimum index of the top sequence that is aligned with the bottom sequence
